...
def main():
    ...
    for i in range(2):
        ...
        all_acc_train_val_s1 = eval_model(cls1, train_val_s1_features, train_val_s1_labels, class_names,
                                          all_acc_train_val_s1)
        print('Now eval stage 2 on train+val set')
        all_acc_train_val_s2 = eval_model(cls2, train_val_s2_features, train_val_s2_labels, class_names,
                                          all_acc_train_val_s2)
